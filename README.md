...
**Spark** [[GitHub](https://github.com/jarviscanada/jarvis_data_eng_HaotianZhu/tree/masterspark)]: Performed big data analytics on retail transaction data using Azure Databricks; Migrated JupyterNotebook from Python Data Analytics project into Azure Databricks and Implement the Notebook writing PySpark code to run queries to solve the business problems. Modified Hadoop project, use SparkSession instead of Hive SQL in Zeppelin Notebook to improve the performance 
